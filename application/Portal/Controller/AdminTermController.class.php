...
class AdminTermController extends AdminbaseController {
    ...
    public function index(){
		...
		$tree->nbsp = '&nbsp;&nbsp;&nbsp;';
		foreach ($result as $r) {
			$r['str_manage'] = '<a href="' . U("AdminTerm/edit", array("id" => $r['term_id'])) . '" class=" btn btn-primary" style="padding: 2px 15px;color: white;background-color: #1dccaa;">'.L('EDIT').'</a> <a class="btn btn-primary js-ajax-delete" style="padding: 2px 15px;color: white;background-color: #1dccaa;" href="' . U("AdminTerm/delete", array("id" => $r['term_id'])) . '">'.L('DELETE').'</a> ';
		...
		$str = "<tr>
					...
					<td style='text-align: center;'>\$spacer <a href='JavaScript:;' target='_blank'>\$name</a></td>
